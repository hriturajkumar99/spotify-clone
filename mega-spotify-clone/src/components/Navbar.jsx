  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        <div className='flex items-center gap2'>
            <img onClick={()=> navigate(-1)} className='w-8 bg-black p2 rounded-2xl cursor-pointer' src={assets.arrow_left} alt="" />
            <img onClick={()=> navigate(1)} className='w-8 bg-black p2 rounded-2xl cursor-pointer' src={assets.arrow_right} alt="" />
        </div>
         <div className='flex items-center gap-4'>
            ...
            <p
            className="bg-green-500 text-black py-1 px-3 rounded-2xl cursor-pointer"
